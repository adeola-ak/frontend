		...
		<div className="intro-text">
			...
			<div className="bio-container">
				...
				<img src={adeolaPhoto} alt="Adeola bio photo" className="team"/>
					<p className="name"><a href="https://www.linkedin.com/in/adeola-a-b0b6b270/" target="_blank">Adeola</a></p>
				...
				<img src={leahPhoto} alt="Leah bio photo" className="team"/>
					<p className="name"><a href="https://www.linkedin.com/in/leah-haake/" target="_blank">Leah</a></p>
				...
				<img src={jessePhoto} alt="Jesse bio photo" className="team"/>
					<p className="name"><a href="https://www.linkedin.com/in/jesse-rouse-92a7aa1b1/" target="_blank">Jesse</a></p>
